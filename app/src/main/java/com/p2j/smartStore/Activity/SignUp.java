...
public class SignUp extends AppCompatActivity implements AdapterView.OnItemSelectedListener, HandlePathOzListener.SingleUri {
    ...
    private static  final String TAG = SignUp.class.getCanonicalName();
            ...
            try {
                ...
                if (mBitmap != null){
                    Subnet_Img.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            uploadImage(mBitmap, S_Cin, "profile");
                            Log.d("uploadImg", ": " + S_Cin + ", :" + mBitmap.getByteCount());
                            if (role == 0) {
